/*
** $Id: gridview.c 10329 2008-06-20 10:18:49Z wangjian $
**
...
static void draw_cell(gvGridViewData* view, HDC hdc, int row, int col)
{
    RECT r;
    gvGridCellData* cell;
...
// MiniGUI Window Messages {{{
        ...
        case MSG_SIZECHANGED:
        {
            ...
            view->scrdata.visibleWidth = RECTWP(rect);
            view->scrdata.visibleHeight = RECTHP(rect);
...
void GridViewControlCleanup (void)
{
    UnregisterWindowClass (CTRL_GRIDVIEW);
}
