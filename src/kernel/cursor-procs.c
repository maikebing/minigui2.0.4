...
#ifdef _USE_NEWGAL
    if (colornum == 1) {
        ExpandMonoBitmap (HDC_SCREEN, pcsr->AndBits, __mg_csrimgpitch, 
                        pANDBits, MONOPITCH, w, h, MYBMP_FLOW_UP, 
                        RGB2Pixel (HDC_SCREEN, 0, 0, 0), 
                        RGB2Pixel (HDC_SCREEN, 0xFF, 0xFF, 0xFF));
        ExpandMonoBitmap (HDC_SCREEN, pcsr->XorBits, __mg_csrimgpitch, 
        ...
        ExpandMonoBitmap (HDC_SCREEN, pcsr->AndBits, __mg_csrimgpitch, 
                        ...
                        RGB2Pixel (HDC_SCREEN, 0, 0, 0), 
                        RGB2Pixel (HDC_SCREEN, 0xFF, 0xFF, 0xFF));
        Expand16CBitmap (HDC_SCREEN, pcsr->XorBits, __mg_csrimgpitch, 
