/*
 * gaopan 20051212 change fprintf releated and LoadEtcFile's sth here, don't flush it before we realize fprintf
 * this file changed to much , good luck.
 * we realized fprintf in a wired way ,sa fprintf.c
 ** $Id: misc-dt.c 7098 2007-01-29 10:28:46Z weiym $
 **
...
/* ***************************CHANGE LOG******************************************
 *	20060124	GAOPAN rewrite SetValueToEtcFile,etc_FileCopy and etc_LocateAndCopy
